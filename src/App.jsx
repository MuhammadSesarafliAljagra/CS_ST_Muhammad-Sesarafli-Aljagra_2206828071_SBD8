            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:block">
                <button
                  ...
                  className="flex items-center justify-center bg-gray-200 text-gray-800 hover:bg-gray-300 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 font-bold py-2 px-4 rounded-full transition duration-300"
                >
            ...
            <div className="md:flex md:items-center md:space-x-12">
              ...
              <div className="md:w-1/2">
                ...
                <p className="mt-4 text-lg text-gray-600">
                  ...
                  and money across 5 Southeast Asian countries. Our super app
                  has been downloaded more than 190 million times and features
                  over 20 services.
                </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="mt-8 space-y-4">
                    <div className="flex items-center">
                      ...
                      <p className="ml-3 text-gray-700">
                        Engineering, Product, Design, and Business roles
                        available
                      </p>
                    </div>
                    <div className="flex items-center">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm hover:shadow-lg transition duration-300 border border-gray-100">
                ...
                <p className="text-gray-600">
                  Continuous learning with regular workshops, mentorship
                  programs, and career development paths.
                </p>
              </div>
            </div>
          </div>
